...
public class SignupTest extends BaseTest {
    ...
    public void testInvalidEmail_REG_AUTO_003() {
        homePage.clickSignInSignUp();
        homePage.selectEmailOption();
        homePage.enterEmailAndContinue("invalidEmailFormat");
    ...
    public void testGenericErrorMessage_REG_AUTO_020() {
        ...
        Assert.assertTrue(homePage.isErrorMessageDisplayed(), "Generic error message element was not displayed!");
    }
}